...
namespace ApacheOrcDotNet.OptimizedReader.Buffers
{
    public class ByteColumnBuffer : BaseColumnBuffer<byte?>
    {
        ...
        private void Fill(ColumnDataStreams streams)
        {
            ...
            ReadByteStream(streams.Data, _dataStreamDecompressedBuffer.AsSpan()[.._dataStreamDecompressedBufferLength], _dataRleBuffer, _dataStreamValues, out var dataValuesRead);
