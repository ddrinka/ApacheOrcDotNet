...
{
    public class FloatWriter : ColumnWriter<float?>
    {
		...
		protected override ColumnEncodingKind DetectEncodingKind(IList<float?> values)
		{
		...
		protected override void EncodeValues(IList<float?> values, IList<OrcCompressedBuffer> buffers, IStatistics statistics)
		{
